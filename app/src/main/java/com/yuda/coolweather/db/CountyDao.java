...
/** 
 * DAO for table "CountyBean".
*/
public class CountyDao extends AbstractDao<County, Long> {

    public static final String TABLENAME = "CountyBean";
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"CountyBean\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"CountyBean\"";
        db.execSQL(sql);
    }
    ...
    @Override
    protected final void attachEntity(County entity) {
