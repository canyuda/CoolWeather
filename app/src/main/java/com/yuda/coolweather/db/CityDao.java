...
/** 
 * DAO for table "CityBean".
*/
public class CityDao extends AbstractDao<City, Long> {

    public static final String TABLENAME = "CityBean";
    ...
    public static class Properties {
        ...
        public final static Property ProviceId = new Property(3, int.class, "proviceId", false, "PROVICE_ID");
    }
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"CityBean\" (" + //
                "\"_id\" INTEGER PRIMARY KEY AUTOINCREMENT ," + // 0: id
                "\"CITY_NAME\" TEXT," + // 1: cityName
                "\"CITY_CODE\" INTEGER NOT NULL ," + // 2: cityCode
                "\"PROVICE_ID\" INTEGER NOT NULL );"); // 3: proviceId
    }

    /** Drops the underlying database table. */
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"CityBean\"";
        db.execSQL(sql);
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, City entity) {
        ...
        stmt.bindLong(4, entity.getProviceId());
    }
    ...
    public City readEntity(Cursor cursor, int offset) {
        City entity = new City( //
            ...
            cursor.getInt(offset + 3) // proviceId
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, City entity, int offset) {
        ...
        entity.setProviceId(cursor.getInt(offset + 3));
     }
