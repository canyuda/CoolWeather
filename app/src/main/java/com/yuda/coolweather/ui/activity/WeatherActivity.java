package com.yuda.coolweather.ui.activity;
...
import com.yuda.coolweather.AutoUpdateService;
import com.yuda.coolweather.R;
import com.yuda.coolweather.bean.Forecast;
...
public class WeatherActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (weatherSting != null){
            HeWeather weather = Utility.handleWeatherResponse(weatherSting);
    ...
    public void requestWeather(final String weatherId) {
        String weatherUrl = "http://guolin.tech/api/weather?cityid=" +
                weatherId +
                "&key=fd17b24a53da468abc283b270fd22c01";
        HttpUtil.sendOkHttpRequest(weatherUrl, new Callback() {
            @Override
            public void onFailure(Call call, IOException e) {
                Toast.makeText
                        (WeatherActivity.this, "获取天气信息失败", Toast.LENGTH_SHORT)
                        .show();
